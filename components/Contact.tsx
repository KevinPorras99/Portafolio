...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-24 text-center animate-fade-in-up" style={{ animationDelay: '500ms' }}>
      ...
      <a href="mailto:johndoe@email.com" className="bg-transparent text-accent border border-accent rounded-md px-12 py-4 hover:bg-accent/10 transition-colors duration-300 font-medium text-lg">
        Say Hello
      </a>
    </section>
  );
